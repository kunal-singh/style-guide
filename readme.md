...
| Package                          | Description                                   |
| -------------------------------- | --------------------------------------------- |
| `@kunal-singh/eslint-config`     | ESLint v9 flat config (base + server presets) |
| `@kunal-singh/prettier-config`   | Prettier config                               |
| `@kunal-singh/typescript-config` | TypeScript configs (base, server, library)    |
...
```sh
npm create @kunal-singh@latest <project-name> [server|library]
```
